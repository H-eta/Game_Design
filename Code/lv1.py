...
def play():
    ...
    balao_judge_3 = os.path.join(game_design_dir, 'Game_Design', 'Sprites', 'limbo_lines_new')
    balao_judge_3_path = os.path.join(balao_judge_3, f'limbo_judge_line_1_new_2.png')
    ...
    while run:
        ...
        if passar_nivel == False and danca == False:
            if check_npc1 == False or check_npc2 == False or check_npc3 == False:
